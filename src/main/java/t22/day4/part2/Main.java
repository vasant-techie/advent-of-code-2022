...
public class Main {
    ...
    private void process(String path) throws IOException {
        ...
        for(String line: lines) {
            ...
            boolean res = isOverlap(firstPairStartNum, firstPairEndNum, secondPairStartNum, secondPairEndNum);
    ...
    private boolean isOverlap(int firstPairStartNum, int firstPairEndNum, int secondPairStartNum, int secondPairEndNum) {
        if(firstPairStartNum < secondPairStartNum && firstPairEndNum < secondPairStartNum) {
            return false;
        } else if(secondPairStartNum < firstPairStartNum && secondPairEndNum < firstPairStartNum) {
            return false;
        }
